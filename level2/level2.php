...
$ID = $_SESSION['user_name'];
	$result = mysqli_query($con, "UPDATE user_table SET level = '../level2/level2.php' WHERE user_name = '$ID'");
?>
...
<body>
	...
	<div class="buttonHolder">
		<button class="start-button" id = "nextButton" style="visibility:hidden;" onclick = "location.href='../level2-1/level2-1.php'" type = button>Next Level</button>
	</div>
